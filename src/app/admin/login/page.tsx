...
export default function AdminLoginPage() {
  ...
  return (
    <>
      ...
      />
      <div
        className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-in-out ${
      ...
      >
        <div className='max-w-md w-full'>
          {/* Card Container */}
          <div
            className={`bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden transition-all duration-700 ease-in-out transform ${
              isTransitioning
