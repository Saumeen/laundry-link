      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <span className={`px-2 py-1 text-xs rounded-full ${getRoleColor(staff.role)}`}>
...
export default function StaffManagementPage() {
  ...
  const staffStats = useMemo(() => {
    ...
    return {
      ...
      operationManagers: staffMembers.filter(s => s.role === 'OPERATION_MANAGER').length,
  ...
  const fetchStaffMembers = useCallback(async (page: number, append = false) => {
    if (page === 1) {
    ...
    try {
      ...
      if (data.success) {
        setStaffMembers(prev => append ? [...prev, ...data.staff] : data.staff);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">Loading Staff Management...</p>
          <p className="text-gray-500 text-sm mt-2">Please wait while we fetch staff data</p>
        </div>
      </div>
    );
  }
          ...
          {showCreateForm && (
            <div className="bg-white shadow rounded-lg p-6 mb-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Create New Staff Member</h3>
                <button
          ...
          {filteredStaffMembers.length === 0 && !staffLoading && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {searchTerm || roleFilter || statusFilter ? 'Try adjusting your search criteria.' : 'No staff members have been added yet.'}
              </p>
            </div>
          )}
        </div>
