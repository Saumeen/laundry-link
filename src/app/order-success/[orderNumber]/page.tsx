      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-12 text-center text-white">
            ...
            <p className="text-xl text-green-100">Thank you for choosing Laundry Link</p>
          </div>
          ...
          <div className="px-8 py-12">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 mb-8">
              <div className="flex items-center justify-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-700">Order Reference</p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed">You'll receive a detailed confirmation email with pickup information and order specifications.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Collection & Processing</h3>
                      <p className="text-gray-600 leading-relaxed">Our professional team will collect your items at the scheduled time and process them with care.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed">Your professionally cleaned items will be delivered back to you at your chosen time and location.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-amber-700">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Duvet, carpet, and dry clean items require 72 hours processing time</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-amber-500 mt-1">•</span>
                      <span>Invoice and service details will be available after item sorting</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-amber-500 mt-1">•</span>
            ...
            <div className="flex justify-center mb-8">
              <Link
                href={isAuthenticated ? "/customer/dashboard" : "/registerlogin"}
              ...
              >
                {isAuthenticated ? "View Your Dashboard" : "Access Your Account"}
              </Link>
            </div>

            {/* Contact Section */}
            <div className="border-t border-gray-200 pt-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-6 text-center">Need assistance?</h3>
