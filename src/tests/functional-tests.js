  ...
  const testCases = [
    {
      ...
      data: {
        ...
        items: [
          { type: "wash_fold", description: "Regular Laundry", quantity: 5, price: 2.50 }
        ],
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { type: "dry_clean", description: "Suits", quantity: 2, price: 6.00 }
        ]
      },
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { type: "ironing", description: "Shirts", quantity: 5, price: 3.00 }
        ]
      },
...
function testTrackingFunctionality() {
  ...
  statusUpdates.forEach(update => {
    console.log(`- Testing status update for order ${update.orderId} to ${update.newStatus}`);
