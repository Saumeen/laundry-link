            ...
            <div className='bg-gray-50 p-4 rounded-lg'>
              ...
              <div className='grid grid-cols-2 gap-4 text-sm'>
                ...
                <div>
                  ...
                  <span
                    className={`ml-2 px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(assignment.status)}`}
                  >
                    ...
                    {assignment.order.address && (
                      <div className='text-sm text-gray-600 mt-1'>
                        {assignment.order.address.building && (
                          <span>
                            Building: {assignment.order.address.building}
                          </span>
                        )}
                        {assignment.order.address.floor && (
                          <span className='ml-2'>
                            Floor: {assignment.order.address.floor}
                          </span>
                        )}
                        {assignment.order.address.apartment && (
                          <span className='ml-2'>
                            Apt: {assignment.order.address.apartment}
                          </span>
                        )}
                        {assignment.order.address.landmark && (
                          <span className='ml-2'>
                            Landmark: {assignment.order.address.landmark}
                          </span>
                        )}
                      </div>
                    )}
              ...
              <div className='space-y-2 text-sm'>
                <div className='flex items-center space-x-2'>
                  ...
                  <span>
                    ...
                    {new Date(
                      assignment.estimatedTime || assignment.order.pickupTime
                    ).toLocaleString()}
                  </span>
                </div>
