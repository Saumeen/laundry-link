  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Pricing Item Management</h2>
          <p className="text-gray-600 mt-1">Manage individual pricing items within categories</p>
        </div>
        <button
      ...
      {editingItem && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-blue-800 font-medium">Editing: {editingItem.displayName}</span>
          </div>
        </div>
      )}
      ...
      {showForm && (
        <div className="mb-6 p-4 border rounded-lg bg-gray-50">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">
                {editingItem ? `Edit Item: ${editingItem.displayName}` : 'Add New Item'}
              </h3>
              {editingItem && (
                <div className="mt-1 text-sm text-gray-600">
                  <span className="mr-4">ID: {editingItem.id}</span>
                  <span className="mr-4">Status: {editingItem.isActive ? 'Active' : 'Inactive'}</span>
                  <span className="mr-4">Category: {editingItem.category?.displayName}</span>
          ...
          <div className="border-t border-gray-200 pt-4">
            <h4 className="text-lg font-medium text-gray-900 mb-4">Item Details</h4>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Price in Bahraini Dinar</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Pricing category this item belongs to</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Display order within category (lower numbers first)</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Whether the item is available for pricing</p>
                </div>
              </div>
