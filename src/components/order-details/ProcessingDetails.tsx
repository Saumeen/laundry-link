...
export function ProcessingDetails({ processingDetails }: ProcessingDetailsProps) {
  ...
  const hasAnyDetails = processingDetails.washType || 
      ...
      <div className='space-y-4'>
        {processingDetails.washType && (
          <div className='flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-blue-700 mb-1'>Wash Type</p>
              <p className='text-base font-semibold text-blue-900'>{processingDetails.washType}</p>
            </div>
          </div>
        )}
        ...
        {processingDetails.dryType && (
          <div className='flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-green-700 mb-1'>Dry Type</p>
              <p className='text-base font-semibold text-green-900'>{processingDetails.dryType}</p>
            </div>
          </div>
        )}
        ...
        {processingDetails.fabricType && (
          <div className='flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-purple-700 mb-1'>Fabric Type</p>
              <p className='text-base font-semibold text-purple-900'>{processingDetails.fabricType}</p>
            </div>
          </div>
        )}
        ...
        {processingDetails.stainTreatment && (
          <div className='flex items-center gap-4 p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-orange-700 mb-1'>Stain Treatment</p>
              <p className='text-base font-semibold text-orange-900'>{processingDetails.stainTreatment}</p>
            </div>
          </div>
        )}
        ...
        {processingDetails.specialInstructions && (
          <div className='flex items-start gap-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-base text-gray-900 leading-relaxed'>{processingDetails.specialInstructions}</p>
            </div>
          </div>
        )}
      </div>
